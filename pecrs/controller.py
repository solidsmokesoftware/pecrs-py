...
class Controller:
   ...
   def make(self, kind, x, y, shape, id=None, dx=0, dy=0):
      """
   ...
   def find(self, x, y):
      ...
      self.pos.x = x
      self.pos.y = y
      return self.space.colliding_at(self.pos, self.pointer)
   ...
   def step(self, delta):
      ...
      for body in self.actives:
         collisions = self.space.colliding_with(body)
         if collisions:
